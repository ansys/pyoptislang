...
*   Loadcase 2 (by dynardo)
*   Minimize the mass
*   0.1 <= a_i <= 20 in^2
*   Maximum stress is 25000*1.35
*
* ------------------------------------------------------------------------------------------------------------------ /
...
object read,,area01 10.0000000000000000,/
object read,,area02 10.0000000000000000,/
object read,,area03 10.0000000000000000,/
object read,,area04 10.0000000000000000,/
object read,,area05 10.0000000000000000,/
object read,,area06 10.0000000000000000,/
object read,,area07 10.0000000000000000,/
object read,,area08 10.0000000000000000,/
object read,,area09 10.0000000000000000,/
object read,,area10 10.0000000000000000,/
...
object create,real,,F3/
object create,real,,F4/
object read,,F1 0.000,/
object read,,F2 0.000,/
object read,,F3 0.000,/
object read,,F4 -200000.000,/
...
* Write output file /
file open, write plain text, "ten_bar_truss2.out", theFile /
