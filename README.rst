...
Installation
------------
The ``ansys-optislang-core`` package supports Python 3.10 through 3.14 on
...
If you're on Windows with Python 3.10, unzip the wheelhouse to a wheelhouse directory and
