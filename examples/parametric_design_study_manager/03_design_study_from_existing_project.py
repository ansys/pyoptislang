...
from ansys.optislang.core.nodes import ParametricSystem, ProxySolverNode, IntegrationNode
...
project_path = Path(r"C:\Users\opanek\DEVELOP\pyosl\testing\rdo_workflow.opf")
